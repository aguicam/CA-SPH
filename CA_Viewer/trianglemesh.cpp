...
void TriangleMesh::buildRoom(){
    ...
    GLfloat vertices[] = {-sizeP, 0.0f, -sizeP, //0
                                  sizeP, 0.0f, -sizeP,//1
                                  sizeP,  sizeP, -sizeP,//2
                                 -sizeP,  sizeP, -sizeP,//3
                                 -sizeP, 0.0f,  sizeP,//4
    ...
    for(i=0; i<8; i+=1)
        addVertex(0.5*QVector3D(vertices[3*i], vertices[3*i+1], vertices[3*i+2]));
    for(i=0; i<8; i++)
        addTriangle(faces[3*i], faces[3*i+1], faces[3*i+2]);
}
void TriangleMesh::buildRight(){
    float sizeP=0.4;

    GLfloat vertices[] = {sizeP, 0.0f, -sizeP,//1
                                  sizeP,  sizeP, -sizeP,//2
                                  sizeP, 0.0f,  sizeP,//5
                                  sizeP,  sizeP,  sizeP,//6
                                };

    GLuint faces[] = {3,1,0,0,2,3
                          };
